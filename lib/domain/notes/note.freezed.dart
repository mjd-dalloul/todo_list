...
abstract class $NoteCopyWith<$Res> {
  ...
  $Res call(
      {UniqueId id, NoteBody body, NoteColor color, List3<TodoItem> todoList});
}
...
class _$NoteCopyWithImpl<$Res> implements $NoteCopyWith<$Res> {
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      todoList:
          todoList == freezed ? _value.todoList : todoList as List3<TodoItem>,
    ));
  }
}
...
class _$_Note extends _Note {
  ...
  @override
  final List3<TodoItem> todoList;

  @override
  String toString() {
    return 'Note(id: $id, body: $body, color: $color, todoList: $todoList)';
  }
...
abstract class _Note extends Note {
  ...
  const factory _Note(
      ...
      @required NoteBody body,
      @required NoteColor color,
      @required List3<TodoItem> todoList}) = _$_Note;
