...
class _$NoteDtoCopyWithImpl<$Res> implements $NoteDtoCopyWith<$Res> {
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      todoList:
          todoList == freezed ? _value.todoList : todoList as List<TodoItemDto>,
...
class _$_NoteDto extends _NoteDto {
  ...
  @override
  String toString() {
    return 'NoteDto(id: $id, body: $body, color: $color, todoList: $todoList, serverTimeStamp: $serverTimeStamp)';
  }
